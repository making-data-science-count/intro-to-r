---
title: "Online Data and Open Source Tools: Analyzing Educational Internet Data Using R"
subtitle: "#aect19inspired"
...
# rmarkdown::render("MTSU-workshop.rmd", output_file = 'index.html')
...
.pull-left[
* Bret Staudt Willet
  * PhD Candidate, Educational Psychology & Educational Technology, Michigan State University
  * Primary area of interest: social media and K-20 educators' ongoing professional learning
...
include_graphics("koehler-diaspora-circa-2017.jpg")
```
...
*The doc is [here](https://github.com/jrosen48/MTSU-workshop/blob/master/demo-doc.Rmd) in the repository*
...
The repository for this workshop is [here](https://github.com/bretsw/aect19-workshop).
...
- [Bret Staudt Willet](mailto:staudtwi@msu.edu)
